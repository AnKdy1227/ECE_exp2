...
oneshot_universal #(.WIDTH(10)) U1(clk, rst, btn, btn_trig);
...
always @(posedge clk or negedge rst) begin    // select segment
 ...
 always @(*) begin      // input bcd output segment expression
    case (bcd[3:0])
