...
always @(btn) begin
    if(!rst) cnt_limit = 0;
        ...
        case(btn)
            8'b00000001 : cnt_limit = C2;  // do
            8'b00000010 : cnt_limit = D2;  // le
            8'b00000100 : cnt_limit = E2;  // mi
            8'b00001000 : cnt_limit = F2;  // pa
            8'b00010000 : cnt_limit = G2;  // sol
            8'b00100000 : cnt_limit = A2;  // la
            8'b01000000 : cnt_limit = B2;  // si
            8'b10000000 : cnt_limit = C3;  // Do
            default : cnt_limit = 0;
          endcase
       end
   end
